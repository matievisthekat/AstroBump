...
module.exports = class extends Command {
  ...
  async exec(msg, args) {
    ...
    if (!desc) return msg.channel.send(new msg.client.embed().red("Please supply a valid description"));
    if (desc.length > 1024)
      return msg.channel.send(
        new msg.client.embed().red("Uh-oh. Looks like your description is too long. Try shortening it")
      );
